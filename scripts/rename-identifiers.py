...
# WHO DECIDES WHICH IS WHICH lives next door. The readers — the compiler's
# spans, the Python tokenizer's, the hand-written JavaScript scanner and the
# quote splitter for the formats with no parser at all — answer « which bytes
# are code »; everything in this file answers « what do I write over them ».
from rename_readers import (
    compiler_spans,
    protected_text_of,
    python_spans,
    quoted_spans,
