...
_ALLOWLIST: frozenset[str] = frozenset(
    {
        ...
        # Optional .env location override for the shared-checkout topology
        # (config.py:_canonical_env_path). A path steering hook, not a secret —
        # it never appears IN a .env, it points AT one.
        "PERSONALSCRAPER_ENV_FILE",
