...
GRANDFATHERED = {
    "engine/legacy.js": ("L13 — the engine dies by subtraction, surface by surface", 32376),
    "engine/states.js": ("L13 — the scenario table goes with the engine it drives", 790),
}
