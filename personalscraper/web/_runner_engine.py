        ...
        while True:
            ...
            for step_argv in steps:
                if len(steps) > 1:
                    ...
                    separator = f"--- {step_label(step_argv)} ---\n"
                ...
                try:
                    ...
                    # ``or None`` keeps the single-step finalize byte-identical
                    # (empty ring → NULL), while a chain that spawned earlier
                    # steps keeps their output.
