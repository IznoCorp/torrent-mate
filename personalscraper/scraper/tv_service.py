    ...
    def scrape_tvshow(self, show_dir: Path) -> ScrapeResult:
        ...
        if _is_nfo_complete(nfo_path):
            ...
            if not is_valid:
                ...
                _persist_drift_issue(self.config, show_dir, drift_reason)
        ...
        _clear_drift_issue(self.config, show_dir)
...
def _persist_drift_issue(config: "Config | None", show_dir: Path, drift_reason: str) -> None:
...
def _clear_drift_issue(config: "Config | None", show_dir: Path) -> None:
