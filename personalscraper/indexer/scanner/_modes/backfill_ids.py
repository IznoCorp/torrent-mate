...
# ---------------------------------------------------------------------------
# init_canonical_from_nfo helpers — extracted to backfill_ids_canonical.py in
# Phase 18 (module-size hard ceiling). Re-exported here so existing imports
...
# / ``_parse_canonical_from_nfo`` / ``_VALID_CANONICAL_PROVIDERS`` /
# ``_INVALID_CANONICAL_VALUES``) keep working unchanged.
# ---------------------------------------------------------------------------
from personalscraper.indexer.scanner._modes.backfill_ids_canonical import (  # noqa: E402
    _INVALID_CANONICAL_VALUES as _INVALID_CANONICAL_VALUES,
)
from personalscraper.indexer.scanner._modes.backfill_ids_canonical import (  # noqa: E402
    _VALID_CANONICAL_PROVIDERS as _VALID_CANONICAL_PROVIDERS,
)
from personalscraper.indexer.scanner._modes.backfill_ids_canonical import (  # noqa: E402
    InitCanonicalStats as InitCanonicalStats,
)
from personalscraper.indexer.scanner._modes.backfill_ids_canonical import (  # noqa: E402
    _parse_canonical_from_nfo as _parse_canonical_from_nfo,
)
from personalscraper.indexer.scanner._modes.backfill_ids_canonical import (  # noqa: E402
    _resolve_nfo_path as _resolve_nfo_path,
)
from personalscraper.indexer.scanner._modes.backfill_ids_canonical import (  # noqa: E402
    init_canonical_from_nfo as init_canonical_from_nfo,
)
