...
| ------------------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **INACTIVE**        | Inactive    | The `~/.kanban/PAUSE` kill-switch is set — the daemon is paused and launches no agents.                                                                                                                          | Resume orchestration with `kanban resume` (clears the PAUSE sentinel).                                                              |
