...
**Three findings adjacent to this table and deliberately outside it**, because saying which is
...
is a product defect `audit.py` CAUGHT, so the instrument worked.
