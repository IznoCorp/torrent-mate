...
**B-371 — the harness host dies with the wrapped invocation that started it, and the mutation tool reads the wreck as a verdict.**
...
8899 host down (B-371) printed « (no hold fell — the rule does not catch this mutation) » and « NO
