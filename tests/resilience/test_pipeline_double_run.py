...
Runs the complete 7-step pipeline twice and verifies that the
...
class TestPipelineDoubleRun:
    ...
    def test_second_run_mostly_skips(
        ...
        mock_verify, mock_dispatch, staging, resilience_settings,
    ):
