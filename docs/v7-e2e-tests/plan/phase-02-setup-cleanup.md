...
- [x] Créer `tests/e2e/setup_torrents.py`
...
- [x] Créer `tests/e2e/cleanup.py`
- [x] `TestCleanup.__init__(registry, dry_run=True)` — dry_run par DÉFAUT
- [x] `cleanup_staging()` : supprime les fichiers de test dans A TRIER/
