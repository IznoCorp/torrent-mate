# r·7 — The arrivals' decisions and pipeline take the contract's names
...
On `533c160e5` (STOP D answered by ruling 105): PENDING_DECISIONS (11 renames), DECISIONS_REGLEES (6), PIPELINE (10). `PendingDecision`/`SettledDecision` read by 5 files each, `Pipeline` by 4.
