...
| **L13b — The engine's verbs and the ladder's shape** | BEHAVIOUR | the 62 delegation names by feature; the engine's gesture listeners; B-290 + B-397 + the 240/260 ms timers; B-275; `legacy.js` cut to 1 601, the residue → L13r | 11 |
| **L13r — The engine's residue** | CONVERSION (r·3's and r·4's behaviour said) | the interface constants and helpers, the fixture families to their seeds, the settings machine, `render()`/`applyState` and the search mount out of the engine, `__referentiel` and its nine slices, `engine-shape`'s family labels renamed to the contract's, the file and its instruments die — **landed** (r·18, 2026-09-15): `legacy.js` 1 601 → 0 (deleted at r·16), `engine-shape.ts` and `__referentiel` gone, one reader round | r·1–r·18 (six planned at ruling 99; every cut a measured STOP D — rulings 101, 105–107, 109, 111, 113, order 42's reason) |
| **L13c — What the engine was blocking** | BEHAVIOUR | B-312, B-340, B-339, B-336, B-331, B-327, B-366, B-345 (library half); the close | 9 |

The operator's cut of 2026-09-13 stands at three KINDS — CONVERSION and BEHAVIOUR — the residue being
the fourth WAVE of the same lot, not a fourth kind; decided under his § 10 delegation on 2026-09-15
(ruling 99, Q5 = B) and reversible by his word.
