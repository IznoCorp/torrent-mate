...
| ACC-04b | `personalscraper verify --check nfo_present -- <path>`                                                                                                                         | Runs only nfo_present check, exits per check result                                    | Phase 6                                                    |
| ACC-05  | `python -c "from personalscraper.verify.checks.registry import registry, CheckStage as S; print(registry.get(S.DISPATCH,'nfo_ids') is not registry.get(S.STAGING,'nfo_ids'))"` | `True`                                                                                 | Phase 5                                                    |
