...
| #   | Phase                                               | File                                               |
| --- | --------------------------------------------------- | -------------------------------------------------- |
| 1   | The extractor, and the classification of all 66     | `phase-01-the-extractor-and-the-classification.md` |
...
| id     | command                                                                                                                                                                        | expected                                                                                                                                                                                                |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ACC-12 | `node scripts/extract-maquette-fixtures.mjs --measure`                                                                                                                         | 64 module-level fixture families over 28 776 lines, and the two function-local ones named                                                                                                               |
