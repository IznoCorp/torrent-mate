...
| #   | Phase                                               | File                                               |
| --- | --------------------------------------------------- | -------------------------------------------------- |
| 1   | The extractor, and the classification of all 88     | `phase-01-the-extractor-and-the-classification.md` |
...
| id     | command                                                                                                                                                                        | expected                                                                                                                                                                                                |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ACC-12 | `node scripts/extract-maquette-fixtures.mjs --measure`                                                                                                                         | 77 module-level fixture families over 28 789 lines, 11 inside a named function and named, 5 inside anonymous ones counted and not inventoried |
...
| ACC-19 | `python3 frontend/maquette/harness/mocks.py`                                                                                                                                   | exit 0, R85's holds all PASS. **Mutation**: make one handler return a fresh object per call, the determinism hold falls and names the operation                                                         |
