...
| D8  | Torr9: ACCEPTANCE criterion = `rg -i "torr9" --type py -g '*.json5' -g '*.ts' -g '*.tsx' personalscraper/ tests/ frontend/src/ config.example/` → zero hits                                                                                                                                                                                                                                        | Executable proof, per operator ask                                                |
...
| D10 | Residual-import gate (Phase Gate rule): `rg -i "lacale" --type py -g '*.ts' -g '*.tsx' -g '*.json5' -g '*.md' personalscraper/ tests/ frontend/src/ config.example/ docs/reference/` → zero hits at the final gate (docs/archive/** and docs/features/rm-lacale/** exempt; historical analysis docs untracked)                                                                                     | The deletion IS the feature; the grep is its proof                                |
