...
| ACC-08 | 2026-08-04 | PASS   | Harnais iframe 390 px, 3 routes (film, série 18 saisons, dégradé). **Re-exercé sur `640f5b4f`** après le correctif de statut. Résultat : `scrollWidth == clientWidth == 386`, **zéro** élément débordant, fiche rendue sur les trois. 18/18 saisons affichent « Épisodes inconnus », **0** « Complète » — TVDB renvoie `episode_count: 0` sur toutes ses saisons, donc l'ancienne logique aurait affiché 18 badges verts « Complète » mensongers. **0** occurrence de « Continuing » (anglais brut) sur les trois routes, remplacé par « En cours ». Titre dégradé : « Fiche indisponible (TMDB 99999999) ». Posters provider chargés (780×1170, 680×1000). |

> **Premier exercice** (`86d4a96b`) : mêmes chiffres de débordement et de complétude, mais le
> statut de série s'affichait « Continuing » en anglais brut (NE-DOIT-PAS-4). C'est cette
> preuve qui a révélé le défaut ; le correctif et le re-exercice sont ci-dessus.
