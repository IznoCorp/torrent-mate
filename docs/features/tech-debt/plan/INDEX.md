...
| 14   | Pipeline-monitor reopen + CI cleanup (re-run 2026-05-25 23h49 — 11 sub-phases : 2 persist + 2 verify + 1 requalif + 5 new + 1 CI)                          | phase-14-pipeline-monitor-reopen.md | 2-3 j   | [ ] post Phase 12 + 13 — re-run a montré 12.1 + 12.7 persistants, 12.4/12.5/12.9 résolus, 12.2/12.8 à verify, 12.3 à requalifier, + 5 nouveaux findings (disk residue AG+AJ, repair_queue schema AR, release_orphans, agents prompts, matrix v2.2) + 14.11 CI cleanup (display literal `${{ matrix... }}` + matrix Python 3.10/3.11/3.13 → 3.12-only)                                                                                                                                                      |
