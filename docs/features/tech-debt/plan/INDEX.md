...
| 9    | CLI Test Coverage (NEW — absorbe 8.7 SH-25 ; **20/20 library-\* harnesses shippés**) | phase-09-cli-coverage.md  | 1.5-2 j | [ ] partial (20 library E2E shipped = 9.3 + 9.4 + library subset of 9.6 done ; 9.1 helpers shipped 11/~20 planned, pin test + golden dir absent ; 9.2 pipeline 0/7 ; 9.5 trailers+config 0/4 ; 9.6 non-library subset 0/4 ; 9.7.a harmonisation 0/20 — Errors/Output/Events absent partout ; 9.7.b matrix doc + report script absent) |
