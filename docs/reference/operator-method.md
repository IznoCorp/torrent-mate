...
| TM refonte 21:0x | 17 — la copie du lecteur épinglée à la tête de la DERNIÈRE porte de phase, re-pointée à la PR READY (`git checkout --detach`) ; mesure : PR READY 19:33 → lecteur 20:08 = 35 min ce soir | ordonné 21:0x | **oui (15/09) : PR READY 03:49 → lecteur spawné 03:52 → handshake 03:52:37 = 3 min 30 ; entérinable** |
