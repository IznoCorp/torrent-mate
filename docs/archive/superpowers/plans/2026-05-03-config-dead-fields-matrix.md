...
| --------------------------------------------- | ------------------------------- | -------- | --------------------------------------------------------------------------------------------- |
| `LibraryConfig.audio.profile_priority`        | `insights/recommender.py`       | KEEP     | Classement audio reel.                                                                        |
...
| `LibraryConfig.subtitles.required_languages`  | `insights/recommender.py`       | KEEP     | Raisons de recommandation si langue requise absente.                                          |
