...
L06 — all `LANDED`. **Branch** `feat/maquette-l07`. **Version** 0.98.37.
...
| ---- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | The base layer, and what the compositor reads       | The three stylesheets exist; the 18 compositor-facing declarations and the six app regions of BLOCK 1 are in the base layer; a rule refuses their removal; `DESIGN_SOURCES` gains the component tree |
