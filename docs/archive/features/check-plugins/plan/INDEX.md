...
| ACC-06b | `rg -t py 'from personalscraper\.verify\.checker import.*\b(Severity\|CheckResult)\b' personalscraper/ tests/`                                                                                                                | rc=1 (no matches)                                                                      | Phase 2 (Severity/CheckResult moved in sub-phase 2.0; re-checked Phase 3) |
