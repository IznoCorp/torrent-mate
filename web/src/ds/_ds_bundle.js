...
const __ds_ns = (window.KanbanMateDesignSystem_2463ad = window.KanbanMateDesignSystem_2463ad || {});
...
function Input({
  ...
  }, leadingAddon && /*#__PURE__*/React.createElement("span", {
    style: {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data-display/ColumnClassChip.jsx", error: String((e && e.message) || e) }); }
...
function HealthPill({
  ...
  }, /*#__PURE__*/React.createElement("style", null, '@keyframes km-ping{0%{transform:scale(1);opacity:.7}70%,100%{transform:scale(2.6);opacity:0}}'))), status), showGithub && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-sans)',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data-display/HealthPill.jsx", error: String((e && e.message) || e) }); }
...
function KeyChip({
  ...
  }, children, copyable && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      opacity: 0.6
    }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data-display/KeyChip.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data-display/ProfileTag.jsx", error: String((e && e.message) || e) }); }
...
function Dialog({
  ...
  }, /*#__PURE__*/React.createElement("style", null, '@keyframes km-fade{from{opacity:0}to{opacity:1}}@keyframes km-pop{from{opacity:0;transform:translateY(6px) scale(.99)}to{opacity:1;transform:none}}'), /*#__PURE__*/React.createElement("div", {
    role: "dialog",
    "aria-modal": "true",
...
function Tooltip({
  ...
  }, /*#__PURE__*/React.createElement("style", null, '@keyframes km-tip{from{opacity:0}to{opacity:1}}'), label));
}
...
function ColumnCard({
  ...
  }, columnKey)), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6,
  ...
  }), columnClass)), children && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/kanban/ColumnCard.jsx", error: String((e && e.message) || e) }); }
...
function FindingItem({
  ...
  }, c.label), field && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 'var(--text-2xs)',
      color: c.fg,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/kanban/FindingItem.jsx", error: String((e && e.message) || e) }); }
...
function TicketCard({
  ...
  }, title), health && /*#__PURE__*/React.createElement("span", {
    style: {
      width: 8,
      height: 8,
      borderRadius: '50%',
  ...
  }, agent.session || agent.label), agent.status && /*#__PURE__*/React.createElement(__ds_scope.HealthPill, {
    status: agent.status,
    size: "sm",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/kanban/TicketCard.jsx", error: String((e && e.message) || e) }); }
...
function TransitionRow({
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.KeyChip, null, Array.isArray(fromCol) ? fromCol.join(' · ') : fromCol), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--col-agent-fg)',
      fontFamily: 'var(--font-mono)',
      fontWeight: 600
    }
  }, "\u2192"), /*#__PURE__*/React.createElement(__ds_scope.KeyChip, {
    tone: "accent"
  }, Array.isArray(toCol) ? toCol.join(' · ') : toCol)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8,
  ...
  }, willLaunch ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 5,
  ...
  }), "launches") : /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 'var(--text-2xs)',
      color: 'var(--text-subtle)'
    }
  }, "no-op"), /*#__PURE__*/React.createElement(__ds_scope.ProfileTag, {
    profile: profile,
    size: "sm"
  }), /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, permissionMode), actions));
}
Object.assign(__ds_scope, { TransitionRow });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/kanban/TransitionRow.jsx", error: String((e && e.message) || e) }); }
...
function NavItem({
  ...
  }), item.label), badge != null && badge > 0 ? /*#__PURE__*/React.createElement(Badge, {
    tone: "red",
    size: "sm"
...
function AppShell({
  ...
  }, "\u2387"), data.binding.project)), /*#__PURE__*/React.createElement("nav", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 2,
  ...
  }, "Configuration"), NAV.map(n => /*#__PURE__*/React.createElement(NavItem, {
    key: n.id,
    item: n,
    active: active === n.id,
    onClick: () => onNav(n.id),
  ...
  }, "kd"), /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 0,
      flex: 1
    }
  ...
  }, "kanban daemon"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 10,
      color: 'var(--muted-foreground)'
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, headerTitle.label), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11,
      color: 'var(--muted-foreground)',
  ...
  }, headerTitle.key))), /*#__PURE__*/React.createElement(HealthPill, {
    ...
    disabled: blocked,
    onClick: onSave
  }, blocked ? `${errorCount} error${errorCount > 1 ? 's' : ''} block save` : dirty ? 'Save config' : 'Saved')), /*#__PURE__*/React.createElement("main", {
    style: {
      flex: 1,
      minHeight: 0,
      overflow: 'auto',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/config/AppShell.jsx", error: String((e && e.message) || e) }); }
...
function ColumnsPanel() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Board columns mirror ", /*#__PURE__*/React.createElement("code", {
    style: {
      fontFamily: 'var(--font-mono)'
    }
  }, "columns.yml"), " order. Moving a card into an ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: 'var(--col-agent-fg)'
    }
  }, "agent"), " column launches a Claude Code agent; a ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: 'var(--col-reactive-fg)'
    }
  }, "reactive"), " column runs a side-effect; ", /*#__PURE__*/React.createElement("b", null, "inert"), " columns are human gates or terminal states."), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "sm"
  ...
  }, count.agent)), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6
  ...
  }, count.reactive)), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6
  ...
  }, count.inert))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: () => c.cls === 'agent' && setOpenKey(open ? null : c.key),
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: 12,
    ...
    }, c.name), /*#__PURE__*/React.createElement(KeyChip, null, c.key), c.key === 'Merge' && /*#__PURE__*/React.createElement(Badge, {
      tone: "red",
      size: "sm"
    }, "human only")), c.note && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: 'var(--muted-foreground)',
        marginTop: 4,
    ...
    }, c.note)), /*#__PURE__*/React.createElement(ColumnClassChip, {
      columnClass: c.cls
    }), c.cls === 'agent' && /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: 'var(--font-mono)',
        fontSize: 13,
        color: 'var(--muted-foreground)',
      ...
      label: "prompt"
    }, /*#__PURE__*/React.createElement(KeyChip, {
      tone: "token"
    }, c.prompt)), /*#__PURE__*/React.createElement(Field, {
      label: "permission_profile"
    }, /*#__PURE__*/React.createElement(ProfileTag, {
      profile: c.profile
    })), /*#__PURE__*/React.createElement(Field, {
      label: "permission_mode"
    }, /*#__PURE__*/React.createElement(KeyChip, null, c.permission_mode)), /*#__PURE__*/React.createElement(Field, {
    ...
    }, c.interactive_only ? 'true' : 'false — fires unattended')))));
  })));
}
function Field({
  label,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/config/ColumnsPanel.jsx", error: String((e && e.message) || e) }); }
...
function DefaultsPanel() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    tone: "neutral"
  }, "Board-wide pipeline defaults from the ", /*#__PURE__*/React.createElement(KeyChip, null, "transitions.yml"), " ", /*#__PURE__*/React.createElement(KeyChip, null, "defaults:"), " block. The daemon and agents always run non-root."), /*#__PURE__*/React.createElement(Card, {
    padding: "none"
...
function ValidationPanel({
  ...
  }, errs.length > 0 ? /*#__PURE__*/React.createElement(Banner, {
    tone: "error",
    title: `${errs.length} error${errs.length > 1 ? 's' : ''} block save`
  }, "Fix the located fields below \u2014 nothing is written until they pass.") : /*#__PURE__*/React.createElement(Banner, {
    tone: "success",
    title: "Config is valid"
  }, "All semantic checks pass. Save writes columns.yml + transitions.yml."), warns.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11,
      letterSpacing: '.06em',
  ...
  }, warns.length, " advisory warning", warns.length > 1 ? 's' : ''), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
    }
  }, findings.map((f, i) => /*#__PURE__*/React.createElement(FindingItem, {
    key: i,
    severity: f.severity,
    field: f.field,
    message: f.message,
...
function YamlPanel() {
  ...
  const transitions = [`project: ${data.binding.project}`, '', 'defaults:', `  concurrency_cap: ${data.defaults.concurrency_cap}`, `  move_rate_limit_per_hour: ${data.defaults.move_rate_limit_per_hour}`, '', 'transitions:', ...data.transitions.flatMap(t => {
  ...
  }, ".claude/kanban/", file)), /*#__PURE__*/React.createElement("pre", {
    style: {
      margin: 0,
      padding: '14px 18px',
      fontFamily: 'var(--font-mono)',
...
function highlight(line) {
  ...
  return esc.replace(/^(\s*-?\s*)([a-z_]+)(:)/, '$1<span style="color:#6cd097">$2</span><span style="color:rgba(255,255,255,0.4)">$3</span>').replace(/(triggers_agent|action): (true|teardown)/, '<span style="color:#6cd097">$1</span><span style="color:rgba(255,255,255,0.4)">:</span> <span style="color:#b6a3e6">$2</span>');
}
Object.assign(window, {
  DefaultsPanel,
  ValidationPanel,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/config/SidePanels.jsx", error: String((e && e.message) || e) }); }
...
function TransitionsPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "The whitelist is order-sensitive \u2014 earlier rows win, and a ", /*#__PURE__*/React.createElement(KeyChip, null, "*"), " wildcard shadows specific rows below it. A row ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: 'var(--col-agent-fg)'
    }
  }, "launches"), " when its destination is an agent column.")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--card)',
      border: '1px solid var(--border)',
      borderRadius: 'var(--radius-lg)',
  ...
  }, "transitions.yml \xB7 ", rows.length, " rows"), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "sm"
  }, "+ Add transition")), rows.map((r, i) => /*#__PURE__*/React.createElement(TransitionRow, {
    key: i,
    fromCol: r.from,
    toCol: r.to,
    profile: r.profile,
  ...
  }, invalidIdx.has(editIdx) && /*#__PURE__*/React.createElement(Banner, {
    tone: "error",
    title: "This row blocks save"
  }, findings.find(f => f.field.startsWith(`transitions[${editIdx}]`))?.message), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    defaultValue: edit.permission_mode === 'bypassPermissions' ? 'acceptEdits' : edit.permission_mode,
    ...
    options: ['stop', 'auto:PRCI', 'auto:Review', 'auto:Done'],
    ...
    placeholder: "No prompt \u2014 script-only / no-op transition"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11,
  ...
  }, "launch: ", edit.willLaunch ? /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--col-agent-fg)',
      fontWeight: 600
    }
  }, "fires agent") : /*#__PURE__*/React.createElement("span", null, "no-op"), "\xB7 ", /*#__PURE__*/React.createElement("span", {
    style: {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/config/TransitionsPanel.jsx", error: String((e && e.message) || e) }); }
...
window.KMConfigData = {
  ...
  findings: [{
    ...
    message: 'permission_mode "bypassPermissions" is not allowed. bypassPermissions is NEVER allowed — use plan, acceptEdits, or auto.'
  }, {
    severity: 'warning',
    field: 'transitions[6].from',
    message: 'wildcard "*" shadows 2 earlier rows. Later specific transitions from the same source are unreachable — move this row last.'
  }, {
    severity: 'warning',
    field: 'defaults.concurrency_cap',
    message: 'concurrency_cap 3 with 4 agent edges: under burst, queued moves wait. Raise the cap or accept serialized launches.'
  }]
};
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/config/data.js", error: String((e && e.message) || e) }); }
