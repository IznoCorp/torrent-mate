...
export function installVerbs(): void {
  // THE SEAM A RULE READS THE REGISTRY THROUGH, filled here because this is
...
/** The registry's names, once it answers — published by the harness as `window.__verbNames`. */
export let verbNames: Window["__verbNames"];
