...
import {
  ...
  const MAINT_ACTIONS = [
    {
      id: "library-status",
      l: "État de la bibliothèque",
      d: "Affiche le résumé du dernier scan d'indexation terminé.",
      g: "query",
      r: "ro",
      long: false,
      blanc: false,
    ...
    {
      id: "library-search",
      l: "Recherche dans la bibliothèque",
      d: "Recherche des médias indexés avec le langage de requête flex-attr.",
      g: "query",
      r: "ro",
      long: false,
      blanc: false,
    ...
    {
      id: "library-show",
      l: "Détail d'un élément",
      d: "Affiche toutes les données stockées pour un média (ID DB).",
      g: "query",
      r: "ro",
      long: false,
      blanc: false,
    ...
    {
      id: "library-index",
      l: "Indexer la bibliothèque",
      d: "Lance un scan complet ou rapide des disques et met à jour l'index.",
      g: "scan",
      r: "write",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Initialiser le provider canonique",
      d: "Peuple canonical_provider et external_ids_json depuis les fichiers NFO.",
      g: "scan",
      r: "write",
      long: true,
      blanc: true,
    ...
    {
      id: "library-scan",
      l: "Scan complet (alias)",
      d: "Alias visible de library-index --mode full. Parcourt tous les disques.",
      g: "scan",
      r: "write",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Backfill des IDs croisés",
      d: "Remplit les IDs cross-provider et les ratings manquants via TMDB/TVDB/OMDb.",
      g: "scan",
      r: "write",
      long: true,
      blanc: true,
    ...
    {
      id: "library-verify",
      l: "Vérifier les fichiers",
      d: "Re-stat chaque fichier indexé et signale les divergences dans la repair_queue.",
      g: "repair",
      r: "write",
      long: true,
      blanc: false,
    ...
    {
      id: "library-repair",
      l: "Réparer (repair queue)",
      d: "Vide la repair_queue dans la limite du budget temps. FIFO, reprenable.",
      g: "repair",
      r: "write",
      long: true,
      blanc: true,
    ...
    {
      id: "library-clean",
      l: "Nettoyer les disques",
      d: "Supprime les répertoires .actors/, dossiers vides et fichiers junk des disques.",
      g: "clean",
      r: "destructive",
      long: true,
      blanc: true,
    ...
    {
      id: "library-validate",
      l: "Valider la bibliothèque",
      d: "Vérifie la conformité des NFO, artworks et nommages des éléments.",
      g: "clean",
      r: "destructive",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Réconcilier index ↔ disques",
      d: "Détecte les divergences entre l'index et les fichiers sans rescan complet.",
      g: "fix",
      r: "write",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Audit des fichiers fantômes",
      d: "Détecte les entrées fantômes NTFS-via-macFUSE sur les disques.",
      g: "query",
      r: "ro",
      long: true,
      blanc: false,
    ...
    {
      id: "library-relink",
      l: "Relier les fichiers orphelins",
      d: "Relie les media_file sans release_id à leur media_release.",
      g: "fix",
      r: "write",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Rafraîchir un dossier renommé",
      d: "Réconciliation d'index ciblée après un rename/move manuel : invalide le sous-arbre, rescanne le disque propriétaire, relie et répare les compteurs.",
      g: "fix",
      r: "write",
      long: true,
      blanc: true,
    ...
    {
      id: "library-analyze",
      l: "Analyser la bibliothèque",
      d: "Résumé des codecs, audio et sous-titres depuis les streams enrichis.",
      g: "analyze",
      r: "ro",
      long: true,
      blanc: false,
    },
    {
      ...
      l: "Recommandations",
      d: "Génère des recommandations de re-téléchargement (codec, taille, priorité).",
      g: "analyze",
      r: "ro",
      long: true,
      blanc: false,
    ...
    {
      id: "library-rescrape",
      l: "Re-scraper des éléments",
      d: "Re-scrape ciblé des éléments via TMDB/TVDB (NFO, artwork, épisodes).",
      g: "analyze",
      r: "destructive",
      long: true,
      blanc: true,
    ...
    {
      id: "library-report",
      l: "Rapport de bibliothèque",
      d: "Affiche les statistiques et l'état de santé global de la bibliothèque.",
      g: "analyze",
      r: "ro",
      long: true,
      blanc: false,
    ...
    {
      id: "library-doctor",
      l: "Diagnostic de la base",
      d: "Exécute une suite de vérifications sur la base indexer (intégrité, FK, dérive…).",
      g: "query",
      r: "ro",
      long: false,
      blanc: false,
    ...
    {
      id: "library-gc",
      l: "Nettoyage de l'outbox",
      d: "Supprime les vieilles lignes index_outbox (status=done) pour éviter la croissance infinie.",
      g: "fix",
      r: "write",
      long: false,
      blanc: true,
    },
    {
      ...
      l: "Corriger canonical_provider",
      d: "Répare les valeurs incorrectes de canonical_provider (shows→tvdb, movies→tmdb).",
      g: "fix",
      r: "write",
      long: false,
      blanc: true,
    ...
    {
      id: "library-fix-nfo",
      l: "Réparer les NFO malformés",
      d: "Tronque le contenu hors-racine XML dans les fichiers NFO (liens TVDB parasites).",
      g: "fix",
      r: "destructive",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Réparer les fichiers orphelins",
      d: "Relie les media_file sans release_id à leur media_release (2 niveaux : item + épisode).",
      g: "fix",
      r: "destructive",
      long: true,
      blanc: true,
    },
    {
      ...
      l: "Corriger le compte d'épisodes",
      d: "Recalcule season.episode_count pour les saisons dont le cache a dérivé.",
      g: "fix",
      r: "write",
      long: false,
      blanc: true,
    },
    {
      ...
      l: "Dédupliquer les titres",
      d: "Fusionne les media_item dont le titre ne diffère que par la normalisation NFD/NFC.",
      g: "fix",
      r: "destructive",
      long: true,
      blanc: true,
      ...
      r: [
        {
          ...
          note: "Folder where qBittorrent deposits completed torrents.",
        },
        {
          f: "paths",
          c: "paths.staging_dir",
          ...
          note: "Intermediate staging folder before dispatch.",
        },
        {
          f: "paths",
          c: "paths.data_dir",
          ...
          note: "Pipeline state directory (index, locks, analysis). Default: .data/ at repo root.",
        },
        {
          f: "disks",
          c: "disks",
          ...
          n: "disks",
          v: "4 entrées",
          note: "Storage disks (variable count). id: free-form identifier used in CLI --disk and logs. path: absolute mounted path. categories: IDs accepted on this disk (builtin + custom_categories).",
        },
        {
          f: "categories",
          c: "custom_categories",
          ...
          n: "custom_categories",
          v: "aucun",
          note: 'Category definitions, classification rules, and genre mappings. Custom category IDs beyond the 11 builtins (optional). Each custom ID must also appear in \'categories\' and be referenced by disks/rules. Example: custom_categories: ["concerts", "short_films"]',
        },
        {
          f: "categories",
        ...
        },
        {
          ...
          n: "category_rules",
          v: "aucun",
          note: "Pattern-based classification rules (evaluated in order, first match wins, BEFORE genre_mapping). Supports: path_contains, path_regex, title_regex, tmdb_genre_contains, tmdb_keyword. Exactly one match_* field per rule.",
        },
        {
          f: "categories",
        ...
        },
        {
          ...
          v: "JP",
          note: "ISO origin_country codes that trigger the rule",
        },
        {
          f: "categories",
        ...
        },
        {
          ...
          n: "applies_to",
          v: "tv",
          note: 'Media types to apply the rule to: "movies", "tv", "both"',
        },
        {
          f: "categories",
      ...
      r: [
        {
          ...
          n: "staging_dirs",
          v: "8 entrées",
          note: 'Staging subdirectory layout — folder patterns inside staging_dir. id: numeric prefix [0-999], name: kebab-case label, file_type: FileType value (null = no fixed type). Exactly one entry must declare role: "ingest" (the entry point for new downloads).',
        },
        {
          f: "encoding",
          ...
          n: "preferred_codec",
          v: "hevc",
          note: "Target codec for encoding recommendations",
        },
        {
          f: "encoding",
          ...
          n: "fallback_codecs",
          v: "av1",
          note: "Acceptable codecs (not flagged)",
        },
        {
          f: "encoding",
      ...
      },
        {
          ...
          n: "profile_priority",
          v: "multi, vf, vostfr +1",
          note: "Ordered preference for audio profiles (multi=multilingual, vf=French dub, vostfr, vo)",
        },
        {
          f: "encoding",
          ...
          v: "fra",
          note: "Required languages (error if absent) — ISO 639-2/T codes",
        },
        {
          f: "encoding",
          ...
          n: "encoding_rules",
          v: "aucun",
          note: 'Encoding override rules for specific media encoding_rules: [ { criteria: { genre: "Animation" }, codec: "hevc", max_size_gb: 6.0, }, ],',
        },
      ],
    },
    {
      ...
      r: [
        ...
        {
          f: "acquire",
          c: "acquire.cadence.tiers",
          type: "structure",
          brut: [
            { max_age_hours: 72, interval_minutes: 120 },
            { max_age_hours: 336, interval_minutes: 1440 },
            { max_age_hours: 720, interval_minutes: 10080 },
          ],
          n: "tiers",
          v: "3 entrées",
          note: "Hot/Warm/Cold backoff — DESIGN §3 frozen policy (D2).",
        },
        {
          f: "acquire",
        ...
        },
        {
          ...
          n: "enabled",
          v: "non",
          note: "ACTIVE. Gated on TR4KER_API_KEY (profile API key, Mon compte → Paramètres), which is present in .env and was live-verified against `GET /api/torznab?t=caps` on 2026-07-28. TR4KER_PASSKEY holds the announce passkey — a different secret, embedded in the .torrent files, which never authenticates the search API.  This file is shared with prod/staging via PERSONALSCRAPER_CONFIG, so an enabled tracker whose gating credential is missing is a BOOT ERROR (build_tracker_registry raises TrackerConfigError) that takes down every command and cron: removing TR4KER_API_KEY from .env requires flipping this back to false in the same change.",
        },
        {
          f: "tracker",
        ...
        },
        {
          ...
          n: "priority",
          v: "c411, tr4ker",
          note: 'economy: TR4KER publishes no explicit seeding obligation (no documented min seed time / H&R grace), so no values are invented here. Until the operator fills this block in, dispatch records an honest tracker-unresolved MISS for tr4ker torrents instead of a wrong rule. economy: { target_ratio: 2.0, min_ratio: 1.0, min_seed_time: "72h", hit_and_run_grace: "0h", },',
        },
        {
          f: "tracker",
        ...
        },
        {
          ...
          v: "20",
          note: "Minimum free space on the staging drive before ingest (GB).",
        },
        {
          f: "thresholds",
          ...
          v: "100",
          note: "Minimum free space on storage disks before dispatch (GB).",
        },
        {
          f: "thresholds",
          ...
          v: "5",
          note: "Consecutive API errors before the circuit breaker opens.",
        },
        {
          f: "thresholds",
          ...
          v: "300",
          note: "Seconds to wait before retrying after the circuit breaker opens.",
        },
        {
          f: "torrent",
          c: "torrent.active",
    ...
    },
    {
      ...
      r: [
        ...
        },
        {
          ...
          n: "languages",
          v: "fr-FR, en-US",
          note: "Ordered language codes for TMDB video lookups. First match wins.",
        },
        {
          f: "trailers",
          ...
          note: "YouTube search query template when TMDB yields nothing. Placeholders: {title}, {year}",
        },
        {
          f: "trailers",
        ...
        },
        {
          ...
          v: "oui",
          note: "When a TMDB-found trailer URL fails to download (any failure except BOT_DETECTED — e.g. YTDLP_ERROR / HTTP_ERROR), attempt a YouTube search for an alternative upload and re-download once. Set to false to keep the pre-0.35.0 behavior (hard failure on first miss).",
        },
      ],
    },
    {
      ...
      r: [
        ...
        },
        {
          ...
          n: "config_version",
          v: "1",
          note: "Master config file (v2 split layout). Copy this directory to ./config/ and fill in your values, or run `personalscraper init-config` to be guided through the setup.  The overlays list names the per-concern files merged in order. Each file must own distinct top-level keys (no key may appear in two overlays). Add a local.json5 (gitignored) for machine-specific overrides.",
        },
        {
          f: "config",
          c: "overlays",
          ...
          n: "overlays",
          v: "paths.json5, disks.json5, categories.json5 +15",
        },
      ],
    },
    /* ── Les passages programmés ────────────────────────────────────────
       The one rubric whose settings do NOT live in a JSON5 overlay. The
       schedules belong to PM2 and sit in `ecosystem.config.js`, which is why
       the file name is written out here rather than derived by appending an
       extension — the save bar promises what it will write, and it may not
       promise a file that does not exist.

       The value read is the hour, because that is what one comes to change;
       the cron expression is underneath, in the mono face, because that is
       what one needs when reading `pm2 jlist`. Their SUCCESS is not here —
       whether a scheduler ran is a health, and healths are Système's. */
    {
      id: "passages",
      ...
      r: [
        {
          ...
          note: "Hourly at :15 — the health check reports to the monitor.",
        },
        {
          f: "ecosystem.config.js",
          ...
          note: "Searches trackers for the episodes and films being followed.",
        },
        {
          f: "ecosystem.config.js",
          ...
          note: "Ten minutes after the search, so it grabs what was just found.",
        },
        {
          f: "ecosystem.config.js",
          ...
          note: "03:00 daily — enqueue newly-aired episodes.",
        },
        {
          f: "ecosystem.config.js",
          ...
          note: "Sundays 04:30 local — off-peak.",
        },
        {
          f: "ecosystem.config.js",
          ...
          note: "Sundays 05:00 local (after enrich).",
        },
      ],
    },
  ];
...
Object.assign(window, {
  ...
  SETTINGS, SETTINGS_STATE, RESOLUTIONS,
