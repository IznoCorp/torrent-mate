...
async def main():
  async with async_playwright() as p:
    ...
    has = await pg.evaluate("""()=>!!document.querySelector('.reslist [data-part="card"] .poster[data-mediasheet]')""")
    await pg.evaluate("""()=>document.querySelector('.reslist [data-part="card"] .poster[data-mediasheet]').click()"""); await pg.wait_for_timeout(600)
