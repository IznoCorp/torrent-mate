...
| 6    | Format + heavy doc work                                              | phase-06-format-docs.md   | 3-4 j  | [x] gate `2007d07` (--format flag + commands.md 39 entries + architecture state ownership + indexer lifecycle + backfill runbook + ENFORCE/PROCESS doc) |
