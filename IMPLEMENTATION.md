...
| **In flight**              | **None.** docs-cleanup merged on 2026-09-01 (pull request 539, squash `81ad0492`) and L14 has not opened. § 0's rule elects the next lot from « Landed, in order »; this row carries a wave only while one is open, and a row that says « in flight » after a merge is B-152's shape |
