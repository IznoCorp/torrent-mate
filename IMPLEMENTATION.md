...
| **Next**                   | **L10 — The live relay** (depends on L09, landed): no wave opens without its design and its plan. The lots run strictly in sequence. **L11 and L12 also satisfy § 0's rule** — L11 depends on L09, L12 on L05 and L07 — and L10 is first in the file's order |
