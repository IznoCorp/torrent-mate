...
| **In flight**              | **L07-bis — the tidy-up.** NOT A LOT, and it does not take L08's turn: a correction wave, arbitrated by the operator on 2026-08-25 immediately after L07 merged, clearing the ground L08 lands on. Thirteen L07 findings plus B-073 were arbitrated in **#498**; this wave executes them. Nothing renders differently except two declarations on the keyboard skip link, which the oracle does not measure and which are named rather than smoothed over |
