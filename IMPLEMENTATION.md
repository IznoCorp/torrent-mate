...
| **In flight**              | **None.** L14 merged on 2026-09-03 and no lot has opened. § 0's rule elects the next from « Landed, in order »; this row says « none » rather than naming a wave nobody has started, because a row that names one is read as a wave in progress |
