...
| **Before it**              | L06 — PR **#490**, version 0.98.32 · L03 — PR **#475**, version 0.98.18 · L02 — PR **#470**, version 0.98.13 · L01 — PR **#467**, version 0.98.10. All three archived under `docs/archive/features/`; L04 and L05 are archived beside them (L04 by #482, L05 by this pull request). L06 and L07 are archived beside them |
...
on it: no design, no plan, no branch. A wave opens with both. What L08 leaves it, ready to use:
