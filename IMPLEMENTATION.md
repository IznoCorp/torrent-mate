...
| **In flight**              | **None.** L13a merged 2026-09-14 and L13b has not opened. § 0's rule elects the next from « Landed, in order »; this row says « none » rather than naming a wave nobody has started, because a row that names one is read as a wave in progress |
