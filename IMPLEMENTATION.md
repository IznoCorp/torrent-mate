...
| **In flight**              | **L04 — boundaries and the tree**, Phase 1. Branch `refactor/maquette-l04`, version 0.98.21. Dependency (L01) satisfied, and it **runs alone**. Design: `docs/features/maquette-l04/DESIGN.md` · plan: `…/plan/INDEX.md`. **The PR row is written the moment the pull request opens** (§ 5 of the architecture file), never after the merge |
