...
| **In flight**              | **L12 — Native interaction**, pull request **#540**, version **0.98.58**, opened 2026-08-31. **VALIDATED BY THE OPERATOR IN THE RUNNING APPLICATION** across four rounds on his own phone — « ok c'est bon pour moi » — after he judged the first build « toujours brut » and had P6's poster carry WITHDRAWN. Transitions, gestures, mobile geometry, the windowed library, and the arrival that animates its pieces as they arrive. **P25 P26 P11 P17 P5 P20 P24 P29 land; B-234 and B-252 close.** The press arbitration and pull-to-refresh leave the engine as vocabulary — **184 lines subtracted, nothing added** (D5). **The operator reversed D9's rule 2 mid-wave** and named `@tanstack/react-virtual`. Gates: 86 rules + 25 guards, `--a11y` clean, hold counts 0 changed, `make check` 10 961 at zero errors, oracle 2 958 no divergence. **B-085 RECOUNTED AT FOURTEEN**, and the sharpest is a rule written for the exact defect it then missed — R115 held that the bar had a group of its own, which was true, while its own principle « the hold is the GROUP, not a pixel » was what blinded it; R118 reads the pixels and its mutation reproduces the filmed defect at drift 51.9 of 255. Register 147 → 150: B-271 to B-277 |
