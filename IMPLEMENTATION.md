...
| **In flight**              | **None.** L12 merged on 2026-09-01 and L14 has not opened. § 0's rule elects the next lot from « Landed, in order »; this row carries a wave only while one is open, and a row that says « in flight » after a merge is B-152's shape — three consecutive waves left it that way and each time the next reader was told the previous lot was still running |
