...
| 9    | CLI Test Coverage (NEW — absorbe 8.7 SH-25 ; 11 harnesses déjà shippés) | phase-09-cli-coverage.md  | 1.5-2 j | [ ] partial (11 library harnesses shipped `b9cb39c..7564153` + `library-relink` untracked ; sections Errors/Output/Events à harmoniser en 9.7.a)        |
